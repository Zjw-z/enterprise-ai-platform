...
class CalculateTripBudgetTool(BaseTool):
    ...
    async def run(self, params: dict) -> ToolResult:
        ...
        daily = {
            "经济": {"hotel": 220, "meal": 100, "transport": 50, "ticket": 80},
            "舒适": {"hotel": 420, "meal": 180, "transport": 100, "ticket": 150},
            "品质": {"hotel": 800, "meal": 320, "transport": 220, "ticket": 260},
        }[level]
        breakdown = {
